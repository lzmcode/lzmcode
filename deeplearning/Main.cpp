...
int main()
{
	...
	/*读取训练文件并保存成图片格式*/
	string filename_train_images = "\\mnist\\train-images-idx3-ubyte";		//train images 文件路径
	string filename_train_labels = "\\mnist\\train-labels-idx1-ubyte";			//train labels 文件路径
	string save_train_image_path = "\\mnist\\train_images\\";						//train images 保存路径
